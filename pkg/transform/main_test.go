...
func Test_Transform(t *testing.T) {
	...
	exp := []gcode.Cmd{
		...
		gcode.Cmd("G0 F2000 X0.0 Y10.0"),
		gcode.Cmd("G0 F2000 X0.0 Y0.0"),
		gcode.Cmd("M400"),
		gcode.Cmd("M280 P0 S150"),
		gcode.Cmd("M400"),
		gcode.Cmd("G0 F2000 X2.0 Y2.0"),
		gcode.Cmd("M400"),
		gcode.Cmd("M280 P0 S30"),
		gcode.Cmd("M400"),
		gcode.Cmd("G5 F257 I-1.0 J2.0 P1.0 Q-2.0 X2.0 Y2.0"),
		...
		gcode.Cmd("M280 P0 S30"),
		gcode.Cmd("M400"),
		gcode.Cmd("G0 F2000 X5.0 Y2.0"),
		gcode.Cmd("G0 F2000 X7.0 Y8.0"),
		gcode.Cmd("G0 F2000 X2.0 Y2.0"),
		gcode.Cmd("G0 F2000 X14.0 Y10.0"),
		gcode.Cmd("G0 F2000 X42.0 Y21.0"),
		gcode.Cmd("M400"),
		gcode.Cmd("M280 P0 S150"),
		gcode.Cmd("M400"),
		gcode.Cmd("M906 X200"),
